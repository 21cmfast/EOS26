...
mkdir -p logs
LOG_OUT="logs/PF_${SLURM_JOB_ID}_zidx${IDX}_N${N}${TEST_SUFFIX}.out"
LOG_ERR="logs/PF_${SLURM_JOB_ID}_zidx${IDX}_N${N}${TEST_SUFFIX}.err"
LOG_LOG="logs/PF_${SLURM_JOB_ID}_zidx${IDX}_N${N}${TEST_SUFFIX}.log"
