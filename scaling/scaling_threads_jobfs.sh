...
echo "WITH EXPORT OMP PROC BIND, ON JOBFS"
...
for hii_dim in "${dimensions[@]}"; do
	...
	cp scaling/results/*.json /scratch/qp00/db9528/EOS26/scaling/results/export_jobfs
...
cp scaling/reports/* /scratch/qp00/db9528/EOS26/scaling/reports/export_jobfs
